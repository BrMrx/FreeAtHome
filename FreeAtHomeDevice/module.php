...
class FreeAtHomeDevice extends IPSModule
{
    ...
    public function Create()
    {
        ...
        IPS_SetVariableProfileAssociation('FAH.WindForce', 8, '8 Bft: stürmischer Wind, 62-74 km/h', "wind-warning", 0xFF00FF);
        IPS_SetVariableProfileAssociation('FAH.WindForce', 9, '9 Bft: Sturm, 75-88 km/h', "wind-warning", 0xFF00FF);
        IPS_SetVariableProfileAssociation('FAH.WindForce', 10, '10 Bft: schwerer Sturm, 89-102 km/h', "wind-warning", 0xFF00FF);
